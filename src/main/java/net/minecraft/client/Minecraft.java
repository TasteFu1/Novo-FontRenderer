...
public class Minecraft implements IThreadListener, ISnooperInfo {
    ...
    public TTFFontRenderer ttfFontRenderer;
    public FontRenderer standardGalacticFontRenderer;
    @Nullable

    /** The GuiScreen that's being displayed at the moment. */ public GuiScreen currentScreen;
    ...
    /** Instance of IntegratedServer. */ private IntegratedServer theIntegratedServer;
    ...
    private void startGame() throws LWJGLException {
        startGame(Initializer::preInit, Initializer::postInit);
    }

    private void startGame(Runnable pre, Runnable post) throws LWJGLException {
        ...
        ResourceLocation location = new ResourceLocation("textures/font/ascii.png");

        this.fontRenderer = new FontRenderer(this.gameSettings, location, this.renderEngine, false);
        this.ttfFontRenderer = new TTFFontRenderer(location, this.renderEngine, false);
        ...
        if (this.currentScreen != null) {
            ...
            if (this.currentScreen != null) {
                try {
                    ...
                    crashreportcategory1.setDetail("Screen name", () -> Minecraft.this.currentScreen.getClass().getCanonicalName());
    ...
    private void func_190521_a(String p_190521_1_, Object... p_190521_2_) {
        this.ingameGUI.getChatGUI().printChatMessage(new TextComponentString("").appendSibling(new TextComponentTranslation("debug.prefix").setStyle(new Style().setColor(TextFormatting.YELLOW).setBold(Boolean.TRUE))).appendText(" ").appendSibling(new TextComponentTranslation(p_190521_1_, p_190521_2_)));
    }
        ...
        if (!Keyboard.isRepeatEvent()) {
            if (!(this.currentScreen instanceof GuiControls) || ((GuiControls) this.currentScreen).time <= getSystemTime() - 20L) {
                if (Keyboard.getEventKeyState()) {
                    ...
                    } else if (i == 48 && GuiScreen.isCtrlKeyDown() && (this.currentScreen == null || !this.currentScreen.func_193976_p())) {
